      ...
      setSyncingItems([
        {
          ...
          absolutePath: "/workspace/documents/document.pdf",
          size: 1024,
      ...
      setPendingItems([
        {
          ...
          absolutePath: "/workspace/documents/report.docx",
          size: 2048,
          createdAt: new Date().toISOString(),
          modifiedAt: new Date().toISOString(),
          syncStatus: "pending",
      ...
      setErrorItems([
        {
          ...
          name: "corrupted.file",
          type: "file",
          path: "/temp/corrupted.file",
          absolutePath: "/workspace/temp/corrupted.file",
          size: 512,
          createdAt: new Date().toISOString(),
          modifiedAt: new Date().toISOString(),
          syncStatus: "error",
